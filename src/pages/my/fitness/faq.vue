  ...
  <view class="faq-container">
    ...
    <view class="faq-categories">
      ...
      <view class="category-list">
        <view 
          class="category-item" 
          :class="{'active': selectedCategory === 'beginner'}"
          @click="filterByCategory('beginner')"
        >
          <nut-icon name="people" size="20"></nut-icon>
          <text>初学者指南</text>
        </view>
        <view 
          class="category-item" 
          :class="{'active': selectedCategory === 'training'}"
          @click="filterByCategory('training')"
        >
          <nut-icon name="checked" size="20"></nut-icon>
          <text>训练技巧</text>
        </view>
        <view 
          class="category-item" 
          :class="{'active': selectedCategory === 'nutrition'}"
          @click="filterByCategory('nutrition')"
        >
          <nut-icon name="shop" size="20"></nut-icon>
          <text>饮食营养</text>
        </view>
        <view 
          class="category-item" 
        ...
        >
          <nut-icon name="star" size="20"></nut-icon>
          <text>器材使用</text>
        </view>
      </view>
    </view>
